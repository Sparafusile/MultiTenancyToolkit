...
namespace SqlServerMultiTenantContext
{
    public abstract class SqlServerMultiTenantContext : MultiTenantContext
    {
        ...
        protected SqlServerMultiTenantContext( string connection, string schema ) : base( connection, schema, DbVendor.SqlServer )
        {
        }
